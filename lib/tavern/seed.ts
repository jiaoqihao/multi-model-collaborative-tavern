...
export function initialStory(): StoryState { return {
  ...
  presetSelection:{director:"",actor:"",settlement:"",narrator:"",memory:""}, stageModels:{settlement:"",narrator:"",memory:""}, characters: []
}; }
...
export function sampleStory(): StoryState { return {
  ...
  presetSelection:{director:"",actor:"",settlement:"",narrator:"",memory:""}, stageModels:{settlement:"",narrator:"",memory:""},
  characters: [
