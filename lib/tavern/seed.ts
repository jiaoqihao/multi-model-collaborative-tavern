...
export function initialStory(): StoryState { return {
  ...
  presetSelection:{director:"",actor:"",settlement:"",narrator:"",memory:""}, stageModels:{settlement:"",narrator:"",memory:""}, collaborationMode:"balanced", context:{threads:[],sceneSummaries:[],chapterSummaries:[]}, characters: []
}; }
